...
100.00%   37.293      1 - -total
 89.90%   33.526     15 - Template:Codeline
-->

<!-- Saved in parser cache with key octave_org:pcache:idhash:18-0!*!0!!en!*!* and timestamp 20171028111723 and revision id 10347
 -->
...
Retrieved from "<a dir="ltr" href="http://wiki.octave.org/wiki/index.php?title=Octave_for_Microsoft_Windows&amp;oldid=10347">http://wiki.octave.org/wiki/index.php?title=Octave_for_Microsoft_Windows&amp;oldid=10347</a>"</div>
		...
		<script>(window.RLQ=window.RLQ||[]).push(function(){mw.loader.load(["mediawiki.toc","mediawiki.action.view.postEdit","site","mediawiki.user","mediawiki.hidpi","mediawiki.page.ready","mediawiki.searchSuggest"]);});</script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":763});});</script></body></html>
